function addPopoverContent()  {
    ...
    <a role="button" class="fas fa-question text text-decoration-none btn btn-link link-light"
        ...
        data-bs-content="Is this an item you would bring on every trip regardless of circumstantial conditions?">
</a>
`)
...
<a role="button" class="fas fa-question text text-decoration-none btn btn-link link-light"
    ...
    data-bs-content="Would this item be beneficial to have in case of an emergency?">
</a>
`)
}
